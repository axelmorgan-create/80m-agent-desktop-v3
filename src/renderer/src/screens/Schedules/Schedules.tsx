...
import { SchedulesDeleteModal } from "./SchedulesDeleteModal";
import type { CronJob, FrequencyType } from "./schedulesTypes";
    ...
    <div className="schedules-container">
      {showCreate && (
        <SchedulesCreateModal
          ...
          setNewDeliver={setNewDeliver}
          newNoAgent={newNoAgent}
          setNewNoAgent={setNewNoAgent}
          newScript={newScript}
          setNewScript={setNewScript}
          newWorkdir={newWorkdir}
          setNewWorkdir={setNewWorkdir}
          frequency={frequency}
          setFrequency={setFrequency}
          minutesInterval={minutesInterval}
          setMinutesInterval={setMinutesInterval}
      ...
      {confirmDelete && (
        <SchedulesDeleteModal
          ...
          onRemove={(jobId) => void handleRemove(jobId)}
        />
      )}
